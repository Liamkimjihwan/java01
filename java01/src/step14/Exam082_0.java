...
=> 기존의 예외 클래스를 사용할 수도 있다.
   ...
   개발사용자 정의 클래스를 만들어 사용할 수 있다.
=> 기존의 클래스를 사용하지않고 새로운 클래스를 만드는 이유는
   - 클래스 이름만으로 어떤 예외인지는 바로 짐작할 수 있다는 이점이 있다.
   - 실행 중에 예외가 발생했을 때 개발자는 어떤 상황에서의 예외가 발생했는지
     바로 짐작할 수 있다.
 */
package step14;
