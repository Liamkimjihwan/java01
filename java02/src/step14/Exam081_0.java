...
import java.io.*;
 public class Exam081_0  {
   // 1) 메서드에서 발생하는 모든 예외를 적는다. , 이용해서
  static void m1(int a) throws Exception, FileNotFoundException, EOFException, IOException {
        if (a == 0) 
...
// 예외 클래스들이 상속 관계에 있을 때 부모 클래스로 묶을 수 있다. 다형적 변수
