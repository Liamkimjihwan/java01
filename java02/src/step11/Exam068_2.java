...
/*
# 상속
- 목표는 기존 코드에 기능을 확장하는 문법
- 기존 코드를 변경하지 않기 때문에 변경에 따른 위험도가 낮아진다.
- 기존 코드를 쉽게 재사용 할 수 있다. => 개발비 절감
- 기존 소스 코드가 없어도 .class 파일만 있어도 상속 받을 수 있다.
- 상속이 없다면 같은 기능을 하는 코드를 매번 중복해 작성할 것이다.
# 상속 용어
예)
class A {}
